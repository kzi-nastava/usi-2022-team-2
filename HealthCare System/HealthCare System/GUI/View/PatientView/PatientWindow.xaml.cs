...
namespace HealthCare_System.GUI.PatientView
{
    public partial class PatientWindow : Window
    {
        ...
        public void InitializeAppointmentHistory()
        {
        ...
        public void InitializeAnamneses( List<Appointment> appointments)
        {
        ...
        public void InitializeDoctorsEdit(Specialization specialization)
        {
        ...
        private void InitializeUpcomingAppointments()
        {
        ...
        private void myAppointmentsLb_SelectionChanged(object sender, SelectionChangedEventArgs e)
        {
            if (myAppointmentsLb.SelectedIndex != -1)
            {
                ...
                InitializeDoctorsEdit(appointment.Doctor.Specialization);
        ...
        #endregion MyAppointmentsTab

        #region AppointmentHistoryTab
        ...
        #endregion AppointmentHistoryTab
        ...
        void UpdateSearchListAnamneses()
        {
            ...
            if (anamnesesSearchTb.Text.Length >= 3 && sortCriteriumCb.SelectedIndex != -1 && sortingDirectionCb.SelectedIndex != -1)
            {
                ...
                InitializeAnamneses(sortedAppointments);
            }
        }
        #endregion AnamnesesTab
