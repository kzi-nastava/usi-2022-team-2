...
namespace HealthCare_System.entities
{
    public class SplittingRenovation : Renovation
    {
        ...
        public SplittingRenovation(int id, DateTime beginningDate, DateTime endingDate) 
            : base(id, beginningDate, endingDate)
        {
            this.room = null;
        }

        public SplittingRenovation(int id, DateTime beginningDate, DateTime endingDate, Room room) 
            : base(id, beginningDate, endingDate)
        {
            this.room = room;
        }
