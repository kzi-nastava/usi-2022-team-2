...
namespace HealthCare_System
{
    ...
    public partial class MainWindow : Window
    {
        ...
        private void loginBtn_Click(object sender, RoutedEventArgs e)
        {
            ...
            factory.AppointmentController.BookAppointment(new DateTime(2022, 4, 24, 13, 57, 0), new DateTime(2022, 4, 24, 14, 12, 0), AppointmentType.EXAMINATION, factory.DoctorController.Doctors[0], factory.PatientController.Patients[0]);
        }
